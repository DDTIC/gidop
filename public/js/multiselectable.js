	...
	$.fn.multiselectable = function (options) {
		...
		options = $.extend({
			template: '<div class="multiselectable">' +
				...
				'</div>' +
				'<div class="m-selectable-controls" style="margin:20px">' +
					'<button type="button" class="multis-right btn btn-block glyphicon glyphicon-chevron-right" style="background-color:#54B944"></button>' +
					'<button type="button" class="multis-left btn btn-block glyphicon glyphicon-chevron-left" style="background-color:#54B944"></button>' +
				'</div>' +
